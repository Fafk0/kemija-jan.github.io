...
function play(){
    ...
    if(GameStatus == Status.start) {
        ...
        canvas.onclick = function(event){
            ...
            GRAVITY = 2;
            elementSort();
            alert("Hej, v tej igri morate izbrati element, ki ga predstavlja mačka (na levi strani zaslona). Na začetku imate tri življenja in ko zgrešite predstavljeni element, izgubite eno življenje. Za vsak pravilen element točka!")
